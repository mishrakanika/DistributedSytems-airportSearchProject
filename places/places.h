...
#define AIRPORTPROG 0x20001111
#define AIRPORTVERS 1

#if defined(__STDC__) || defined(__cplusplus)
#define LISTAIRPORT 1
extern  list_airport_res * listairport_1(user_input *, CLIENT *);
extern  list_airport_res * listairport_1_svc(user_input *, struct svc_req *);
...
extern  bool_t xdr_list_airport_res (XDR *, list_airport_res*);
...
extern bool_t xdr_list_airport_res ();
